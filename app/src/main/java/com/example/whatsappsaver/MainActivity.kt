...
import com.example.whatsappsaver.navigation.NavEntry
import com.example.whatsappsaver.Screens.WhatsAppStatusScreen
import com.example.whatsappsaver.ui.theme.WhatsAppStatusSaverTheme
    ...
    Box(
        modifier = Modifier
            ...
            .background(
                brush = Brush.linearGradient(
                    colors = listOf(Color(0xFF4B59A7), Color(0xFF3954E6)),
                    start = Offset(0f, 0f),
                    end = Offset.Infinite
                )
            ),
        ...
        Column(
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.logolauncherapp),
